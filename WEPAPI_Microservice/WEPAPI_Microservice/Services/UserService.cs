...
using WEAPI_Microservice.Services;
...
namespace WEPAPI_Microservice.Services
{
    public class UserService
    {
        ...
        private readonly DatabaseEncryptionService encryptionService;
        ...
        private DbUser GetById(string id) => _users.Find<DbUser>(user => user.Id == id).FirstOrderDefault();
